...
public class Listeners extends TestListenerAdapter {
    ...
    {
        htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+ "/target/Reports/myReport.html");//specify location of the report
        ...
        extent.setSystemInfo("user","cerbersse");
